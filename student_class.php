					...
					<div class="row">
						<div class="col-sm-7">
							<div class="graph">
								...
								left join usertbl on usertbl.id = tblstudentclass.studentid
								left join tblsubjects on tblsubjects.id = tblstudentclass.subjectid
								left join tblclass on tblclass.id = tblstudentclass.classid";
								$result = mysqli_query($con, $query)or die(mysqli_error($con));
								if(mysqli_num_rows($result) > 0){
									?>
									<button type="button" id="del_stud_class" class="btn btn-danger">Delete</button>
									<button type="submit" name="del_studclass" id="submit_studclass" style="display:none;">delete</button>
									<div class="tables">
										<table class="table table-bordered"> 
											...
											<tbody> 
												...
												<tr> 
													...
													<td><input type="hidden" value="<?php echo $row['id'] ?>"><?php echo $row['fname']." ".$row['mname']." ".$row['lname']; ?></td>
