									...
									<table class="table table-bordered"> 
										...
										<tbody> 
											...
											while($row = mysqli_fetch_array($result))
											{
												...
												<tr> 
													<td><input type="checkbox" id="checkall" name="classid" value=""></td>
													...
													<td width="50"><button style="margin:0px;padding:8px;" classid="<?php echo $row['id']; ?>" schoolyearid="<?php echo $row['schoolyearid']; ?>" yearlevelid="<?php echo $row['yearlevelid']; ?>" classname="<?php echo $row['classname']; ?>" schoolyear="<?php echo $schoolyear; ?>" yearlevel="<?php echo $yearlevel; ?>" onclick="edit(this)" class="btn btn-success">Edit</button></td> 
								...
								<div class="graph">
									<form class="form-horizontal" name="add_class_form" method="post">
										...
										<div class="form-group">
											...
											<select class="form-control" style="height:44px;" name="cboSchoolYear" id="cboSchoolYear">
												<option></option>
												<?php 
											...
											<div class="form-group">
												...
												<select class="form-control" style="height:44px;" name="cboYearLevel"  id="cboYearLevel">
													<option></option>
													<?php 
